    ...
    <div>
      ...
      {Array(totalPages)
        ...
        .map((_, idx) => {
          if (idx < 10) {
            return (
              <span className={`page-click ${currentPage === idx + 1 && 'active-page'}`} key={idx} onClick={() => onClick(idx + 1)}>
                {idx + 1}
              </span>
            )
            ...
            return (
              <span key={idx}>
                ...
                <span className={`page-click ${(currentPage === idx + 1 || currentPage === 500) && 'active-page'}`} onClick={() => onClick(totalPages > 500 ? 500 : totalPages)}>
